 ...
 */
final class Version20190609085140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE email ADD COLUMN sender_name CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE email ADD COLUMN sender_email CLOB DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__craftsman');
        $this->addSql('CREATE INDEX IDX_7DC593834994A532 ON craftsman (construction_site_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__email AS SELECT id, receiver, subject, body, action_text, action_link, email_type, sent_date_time, visited_date_time FROM email');
        ...
        $this->addSql('INSERT INTO email (id, receiver, subject, body, action_text, action_link, email_type, sent_date_time, visited_date_time) SELECT id, receiver, subject, body, action_text, action_link, email_type, sent_date_time, visited_date_time FROM __temp__email');
        ...
        , public_access_identifier CLOB DEFAULT NULL, access_allowed_until DATETIME DEFAULT NULL, last_access DATETIME DEFAULT NULL, is_marked BOOLEAN DEFAULT NULL, any_status INTEGER DEFAULT NULL, filter_by_issues BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_craftsmen BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_trades BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_maps BOOLEAN DEFAULT \'0\' NOT NULL, registration_status BOOLEAN DEFAULT NULL, registration_start DATETIME DEFAULT NULL, registration_end DATETIME DEFAULT NULL, responded_status BOOLEAN DEFAULT NULL, responded_start DATETIME DEFAULT NULL, responded_end DATETIME DEFAULT NULL, reviewed_status BOOLEAN DEFAULT NULL, reviewed_start DATETIME DEFAULT NULL, reviewed_end DATETIME DEFAULT NULL, limit_start DATETIME DEFAULT NULL, limit_end DATETIME DEFAULT NULL, construction_site_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        ...
        , trades CLOB DEFAULT \'NULL --(DC2Type:simple_array)\' COLLATE BINARY --(DC2Type:simple_array)
