...
final class Version20200409130946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO construction_manager (id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, is_enabled, registration_date, is_trial_account, authentication_hash, is_registration_completed) SELECT id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, is_enabled, registration_date, is_trial_account, authentication_hash, is_registration_completed FROM __temp__construction_manager');
        ...
        , PRIMARY KEY(id), CONSTRAINT FK_7FC45F1D4994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_450D96CDE7927C74');
        $this->addSql('DROP INDEX IDX_450D96CDA7F12217');
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_manager AS SELECT id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, created_at, last_changed_at, email, password, password_hash, authentication_hash, is_enabled, is_registration_completed, registration_date FROM construction_manager');
        $this->addSql('DROP TABLE construction_manager');
        ...
        $this->addSql('INSERT INTO construction_manager (id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, created_at, last_changed_at, email, password, password_hash, authentication_hash, is_enabled, is_registration_completed, registration_date) SELECT id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, created_at, last_changed_at, email, password, password_hash, authentication_hash, is_enabled, is_registration_completed, registration_date FROM __temp__construction_manager');
        $this->addSql('DROP TABLE __temp__construction_manager');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_450D96CDE7927C74 ON construction_manager (email)');
        $this->addSql('CREATE INDEX IDX_450D96CDA7F12217 ON construction_manager (active_construction_site_id)');
        $this->addSql('DROP INDEX IDX_BF4E61B43DA5256D');
