...
namespace App\Tests\Service\Report\Document\Pdf\Mock;

use App\Service\Report\Document\Pdf\Configuration\ConfigurationValidator;
...
class PdfDocumentMock implements PdfDocumentInterface
{
    ...
    public function __construct()
    {
        ...
        $this->printConfiguration = new PrintConfiguration(new ConfigurationValidator());
    }
