...
class MapFile extends BaseEntity
{
    ...
    {
        if ($this->sectorFrame !== null && !$this->sectorFrame instanceof Frame) {
            $this->sectorFrame = Frame::createFromStdClass($this->sectorFrame);
        }
     ...
     */
    public function setSectorFrame($sectorFrame): void
    {
