 ...
 */
final class Version20180703081353 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, email CLOB NOT NULL COLLATE BINARY, password CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, reset_hash CLOB NOT NULL COLLATE BINARY, is_enabled BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_450D96CDA7F12217 FOREIGN KEY (active_construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__craftsman AS SELECT id, construction_site_id, contact_name, company, trade, email, created_at, last_changed_at, street_address, postal_code, locality, country, last_email_sent, last_online_visit, email_identifier FROM craftsman');
        $this->addSql('DROP TABLE craftsman');
        $this->addSql('CREATE TABLE craftsman (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , construction_site_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , contact_name CLOB NOT NULL COLLATE BINARY, company CLOB NOT NULL COLLATE BINARY, trade CLOB NOT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, last_email_sent DATETIME DEFAULT NULL, last_online_visit DATETIME DEFAULT NULL, email_identifier CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_7DC593834994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO craftsman (id, construction_site_id, contact_name, company, trade, email, created_at, last_changed_at, street_address, postal_code, locality, country, last_email_sent, last_online_visit, email_identifier) SELECT id, construction_site_id, contact_name, company, trade, email, created_at, last_changed_at, street_address, postal_code, locality, country, last_email_sent, last_online_visit, email_identifier FROM __temp__craftsman');
        $this->addSql('DROP TABLE __temp__craftsman');
        $this->addSql('CREATE INDEX IDX_7DC593834994A532 ON craftsman (construction_site_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, is_marked, number, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, trades, craftsmen, maps, construction_site FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , is_marked BOOLEAN DEFAULT NULL, number INTEGER DEFAULT NULL, read_status BOOLEAN DEFAULT NULL, responded_status BOOLEAN DEFAULT NULL, responded_start DATETIME DEFAULT NULL, responded_end DATETIME DEFAULT NULL, reviewed_status BOOLEAN DEFAULT NULL, reviewed_start DATETIME DEFAULT NULL, reviewed_end DATETIME DEFAULT NULL, limit_start DATETIME DEFAULT NULL, limit_end DATETIME DEFAULT NULL, construction_site VARCHAR(255) DEFAULT NULL COLLATE BINARY, trades CLOB DEFAULT NULL --(DC2Type:simple_array)
        , craftsmen CLOB DEFAULT NULL --(DC2Type:simple_array)
        , maps CLOB DEFAULT NULL --(DC2Type:simple_array)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, trades, craftsmen, maps, construction_site) SELECT id, is_marked, number, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, trades, craftsmen, maps, construction_site FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_site AS SELECT id, name, image_file_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM construction_site');
        ...
        , name CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, image_filename CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO construction_site (id, name, image_filename, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, name, image_file_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__construction_site');
        ...
        $this->addSql('DROP INDEX UNIQ_12AD233E96901F54');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_12AD233E96901F54 ON issue (number)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_450D96CDE7927C74 ON construction_manager (email)');
        $this->addSql('CREATE INDEX IDX_450D96CDA7F12217 ON construction_manager (active_construction_site_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_site AS SELECT id, name, image_filename, created_at, last_changed_at, street_address, postal_code, locality, country FROM construction_site');
        $this->addSql('DROP TABLE construction_site');
        $this->addSql('CREATE TABLE construction_site (id CHAR(36) NOT NULL --(DC2Type:guid)
        , name CLOB NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL, country CLOB DEFAULT NULL, image_file_name CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO construction_site (id, name, image_file_name, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, name, image_filename, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__construction_site');
        $this->addSql('DROP TABLE __temp__construction_site');
        $this->addSql('DROP INDEX IDX_BC4D21F04994A532');
        $this->addSql('DROP INDEX IDX_BC4D21F0A69C9147');
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_site_construction_manager AS SELECT construction_site_id, construction_manager_id FROM construction_site_construction_manager');
        ...
        $this->addSql('CREATE INDEX IDX_BC4D21F0A69C9147 ON construction_site_construction_manager (construction_manager_id)');
        $this->addSql('DROP INDEX IDX_7DC593834994A532');
        $this->addSql('CREATE TEMPORARY TABLE __temp__craftsman AS SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country FROM craftsman');
        $this->addSql('DROP TABLE craftsman');
        $this->addSql('CREATE TABLE craftsman (id CHAR(36) NOT NULL --(DC2Type:guid)
        , contact_name CLOB NOT NULL, company CLOB NOT NULL, trade CLOB NOT NULL, email CLOB NOT NULL, last_email_sent DATETIME DEFAULT NULL, last_online_visit DATETIME DEFAULT NULL, email_identifier CLOB DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL, country CLOB DEFAULT NULL, construction_site_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO craftsman (id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__craftsman');
        $this->addSql('DROP TABLE __temp__craftsman');
        $this->addSql('CREATE INDEX IDX_7DC593834994A532 ON craftsman (construction_site_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, construction_site, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM filter');
        $this->addSql('DROP TABLE filter');
        ...
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, construction_site, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end) SELECT id, construction_site, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('DROP INDEX UNIQ_12AD233E96901F54');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
        $this->addSql('DROP INDEX IDX_12AD233E254D80EC');
