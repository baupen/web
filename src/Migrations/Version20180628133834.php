 ...
 */
final class Version20180628133834 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_manager AS SELECT id, given_name, family_name, phone, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, agb_accepted FROM construction_manager');
        ...
        $this->addSql('INSERT INTO construction_manager (id, given_name, family_name, phone, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, agb_accepted) SELECT id, given_name, family_name, phone, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, agb_accepted FROM __temp__construction_manager');
