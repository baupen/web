 ...
 */
final class Version20180720120343 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, trades, craftsmen, maps FROM filter');
        ...
        , registration_start DATETIME DEFAULT NULL, registration_end DATETIME DEFAULT NULL, read_status BOOLEAN DEFAULT NULL, share_access_limit DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, trades, craftsmen, maps) SELECT id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, trades, craftsmen, maps FROM __temp__filter');
