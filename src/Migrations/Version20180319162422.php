 ...
 */
class Version20180319162422 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        , name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, file_name CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_B8D991E4D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        , name CLOB NOT NULL, description CLOB DEFAULT NULL, building_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        , file_name CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO building_map (id, building_id, file_name, name, description) SELECT id, building_id, file_name, name, description FROM __temp__building_map');
        $this->addSql('DROP TABLE __temp__building_map');
        $this->addSql('CREATE INDEX IDX_B8D991E4D2A7E12 ON building_map (building_id)');
        $this->addSql('DROP INDEX IDX_82CF20FE34508F72');
