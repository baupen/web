 ...
 */
final class Version20200703072909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , construction_site_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , map_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, filename CLOB NOT NULL COLLATE BINARY, display_filename CLOB NOT NULL COLLATE BINARY, hash CLOB NOT NULL COLLATE BINARY, sector_frame CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        ...
        , file_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__craftsman AS SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country, write_authorization_token FROM craftsman');
        $this->addSql('DROP TABLE craftsman');
        $this->addSql('CREATE TABLE craftsman (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , construction_site_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , contact_name CLOB NOT NULL COLLATE BINARY, company CLOB NOT NULL COLLATE BINARY, trade CLOB NOT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, last_email_sent DATETIME DEFAULT NULL, last_online_visit DATETIME DEFAULT NULL, email_identifier CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, write_authorization_token CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_7DC593834994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO craftsman (id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country, write_authorization_token) SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country, write_authorization_token FROM __temp__craftsman');
        ...
        , active_construction_site_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, locale CLOB DEFAULT \'de\' NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, email CLOB NOT NULL COLLATE BINARY, password CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, is_enabled BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, is_trial_account BOOLEAN DEFAULT \'0\' NOT NULL, authentication_hash CLOB NOT NULL COLLATE BINARY, is_registration_completed BOOLEAN NOT NULL, is_external_account BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_450D96CDA7F12217 FOREIGN KEY (active_construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO construction_manager (id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, is_enabled, registration_date, is_trial_account, authentication_hash, is_registration_completed, is_external_account) SELECT id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, is_enabled, registration_date, is_trial_account, authentication_hash, is_registration_completed, is_external_account FROM __temp__construction_manager');
        ...
        , upload_by_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , registration_by_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , response_by_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , review_by_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , image_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , craftsman_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , map_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        ...
        , issue_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        ...
        $this->addSql('DROP INDEX IDX_7FC45F1D4994A532');
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, construction_site_id, is_marked, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, last_access, any_status, access_allowed_until, public_access_identifier, filter_by_issues, filter_by_craftsmen, filter_by_trades, filter_by_maps, trades, craftsmen, maps, issues FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , construction_site_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , is_marked BOOLEAN DEFAULT NULL, registration_status BOOLEAN DEFAULT NULL, registration_start DATETIME DEFAULT NULL, registration_end DATETIME DEFAULT NULL, responded_status BOOLEAN DEFAULT NULL, responded_start DATETIME DEFAULT NULL, responded_end DATETIME DEFAULT NULL, reviewed_status BOOLEAN DEFAULT NULL, reviewed_start DATETIME DEFAULT NULL, reviewed_end DATETIME DEFAULT NULL, limit_start DATETIME DEFAULT NULL, limit_end DATETIME DEFAULT NULL, last_access DATETIME DEFAULT NULL, any_status INTEGER DEFAULT NULL, access_allowed_until DATETIME DEFAULT NULL, public_access_identifier CLOB DEFAULT NULL COLLATE BINARY, filter_by_issues BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_craftsmen BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_trades BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_maps BOOLEAN DEFAULT \'0\' NOT NULL, trades CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:simple_array)
        , craftsmen CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:simple_array)
        , maps CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:simple_array)
        , issues CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:simple_array)
        , was_added_with_client BOOLEAN DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_7FC45F1D4994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO filter (id, construction_site_id, is_marked, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, last_access, any_status, access_allowed_until, public_access_identifier, filter_by_issues, filter_by_craftsmen, filter_by_trades, filter_by_maps, trades, craftsmen, maps, issues) SELECT id, construction_site_id, is_marked, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, last_access, any_status, access_allowed_until, public_access_identifier, filter_by_issues, filter_by_craftsmen, filter_by_trades, filter_by_maps, trades, craftsmen, maps, issues FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('CREATE INDEX IDX_7FC45F1D4994A532 ON filter (construction_site_id)');
        ...
        , construction_manager_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        ...
        , issue_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , map_file_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        ...
        , created_by_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , construction_site_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_450D96CDE7927C74');
        $this->addSql('DROP INDEX IDX_450D96CDA7F12217');
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_manager AS SELECT id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, is_external_account, created_at, last_changed_at, email, password, password_hash, authentication_hash, is_enabled, is_registration_completed, registration_date FROM construction_manager');
        $this->addSql('DROP TABLE construction_manager');
        ...
        , given_name CLOB DEFAULT NULL, family_name CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, locale CLOB DEFAULT \'de\' NOT NULL, is_trial_account BOOLEAN DEFAULT \'0\' NOT NULL, is_external_account BOOLEAN DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, email CLOB NOT NULL, password CLOB NOT NULL, password_hash CLOB NOT NULL, authentication_hash CLOB NOT NULL, is_enabled BOOLEAN NOT NULL, is_registration_completed BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO construction_manager (id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, is_external_account, created_at, last_changed_at, email, password, password_hash, authentication_hash, is_enabled, is_registration_completed, registration_date) SELECT id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, is_external_account, created_at, last_changed_at, email, password, password_hash, authentication_hash, is_enabled, is_registration_completed, registration_date FROM __temp__construction_manager');
        $this->addSql('DROP TABLE __temp__construction_manager');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_450D96CDE7927C74 ON construction_manager (email)');
        $this->addSql('CREATE INDEX IDX_450D96CDA7F12217 ON construction_manager (active_construction_site_id)');
        $this->addSql('DROP INDEX IDX_BF4E61B43DA5256D');
        ...
        $this->addSql('CREATE INDEX IDX_DFC5717E4994A532 ON construction_site_image (construction_site_id)');
        $this->addSql('DROP INDEX IDX_7DC593834994A532');
        $this->addSql('CREATE TEMPORARY TABLE __temp__craftsman AS SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, write_authorization_token, created_at, last_changed_at, street_address, postal_code, locality, country FROM craftsman');
        $this->addSql('DROP TABLE craftsman');
        $this->addSql('CREATE TABLE craftsman (id CHAR(36) NOT NULL --(DC2Type:guid)
        , construction_site_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , contact_name CLOB NOT NULL, company CLOB NOT NULL, trade CLOB NOT NULL, email CLOB NOT NULL, last_email_sent DATETIME DEFAULT NULL, last_online_visit DATETIME DEFAULT NULL, email_identifier CLOB NOT NULL, write_authorization_token CLOB NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL, country CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO craftsman (id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, write_authorization_token, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, write_authorization_token, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__craftsman');
        $this->addSql('DROP TABLE __temp__craftsman');
        $this->addSql('CREATE INDEX IDX_7DC593834994A532 ON craftsman (construction_site_id)');
        $this->addSql('DROP INDEX IDX_7FC45F1D4994A532');
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, construction_site_id, public_access_identifier, access_allowed_until, last_access, is_marked, issues, any_status, filter_by_issues, craftsmen, filter_by_craftsmen, trades, filter_by_trades, maps, filter_by_maps, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id CHAR(36) NOT NULL --(DC2Type:guid)
        , construction_site_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , public_access_identifier CLOB DEFAULT NULL, access_allowed_until DATETIME DEFAULT NULL, last_access DATETIME DEFAULT NULL, is_marked BOOLEAN DEFAULT NULL, issues CLOB DEFAULT NULL --(DC2Type:simple_array)
        , any_status INTEGER DEFAULT NULL, filter_by_issues BOOLEAN DEFAULT \'0\' NOT NULL, craftsmen CLOB DEFAULT NULL --(DC2Type:simple_array)
        , filter_by_craftsmen BOOLEAN DEFAULT \'0\' NOT NULL, trades CLOB DEFAULT NULL --(DC2Type:simple_array)
        , filter_by_trades BOOLEAN DEFAULT \'0\' NOT NULL, maps CLOB DEFAULT NULL --(DC2Type:simple_array)
        , filter_by_maps BOOLEAN DEFAULT \'0\' NOT NULL, registration_status BOOLEAN DEFAULT NULL, registration_start DATETIME DEFAULT NULL, registration_end DATETIME DEFAULT NULL, responded_status BOOLEAN DEFAULT NULL, responded_start DATETIME DEFAULT NULL, responded_end DATETIME DEFAULT NULL, reviewed_status BOOLEAN DEFAULT NULL, reviewed_start DATETIME DEFAULT NULL, reviewed_end DATETIME DEFAULT NULL, limit_start DATETIME DEFAULT NULL, limit_end DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, construction_site_id, public_access_identifier, access_allowed_until, last_access, is_marked, issues, any_status, filter_by_issues, craftsmen, filter_by_craftsmen, trades, filter_by_trades, maps, filter_by_maps, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end) SELECT id, construction_site_id, public_access_identifier, access_allowed_until, last_access, is_marked, issues, any_status, filter_by_issues, craftsmen, filter_by_craftsmen, trades, filter_by_trades, maps, filter_by_maps, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('CREATE INDEX IDX_7FC45F1D4994A532 ON filter (construction_site_id)');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
        $this->addSql('DROP INDEX IDX_12AD233E254D80EC');
        ...
        , position_x DOUBLE PRECISION NOT NULL, position_y DOUBLE PRECISION NOT NULL, position_zoom_scale DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, PRIMARY KEY(id))');
        ...
        , name CLOB NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, is_automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO map (id, construction_site_id, parent_id, file_id, name, created_at, last_changed_at, is_automatic_edit_enabled) SELECT id, construction_site_id, parent_id, file_id, name, created_at, last_changed_at, is_automatic_edit_enabled FROM __temp__map');
        $this->addSql('DROP TABLE __temp__map');
        $this->addSql('CREATE INDEX IDX_93ADAABB4994A532 ON map (construction_site_id)');
        $this->addSql('CREATE INDEX IDX_93ADAABB727ACA70 ON map (parent_id)');
        ...
        , identifier CLOB NOT NULL, is_automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO map_sector (id, map_file_id, name, color, points, identifier, is_automatic_edit_enabled) SELECT id, map_file_id, name, color, points, identifier, is_automatic_edit_enabled FROM __temp__map_sector');
        $this->addSql('DROP TABLE __temp__map_sector');
        $this->addSql('CREATE INDEX IDX_F2702D4BCE08130 ON map_sector (map_file_id)');
        $this->addSql('DROP INDEX IDX_CFBDFA14B03A8386');
