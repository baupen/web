 ...
 */
final class Version20181203163305 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__map AS SELECT id, construction_site_id, parent_id, name, created_at, last_changed_at FROM map');
        ...
        , name CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, prevent_automatic_edit CLOB DEFAULT \'\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_93ADAABB4994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_93ADAABB727ACA70 FOREIGN KEY (parent_id) REFERENCES map (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_93ADAABB93CB796C FOREIGN KEY (file_id) REFERENCES map_file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO map (id, construction_site_id, parent_id, name, created_at, last_changed_at) SELECT id, construction_site_id, parent_id, name, created_at, last_changed_at FROM __temp__map');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_site AS SELECT id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM construction_site');
        ...
        , name CLOB NOT NULL COLLATE BINARY, folder_name CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, prevent_automatic_edit CLOB DEFAULT \'\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_BF4E61B43DA5256D FOREIGN KEY (image_id) REFERENCES construction_site_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO construction_site (id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__construction_site');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__issue AS SELECT id, upload_by_id, registration_by_id, response_by_id, review_by_id, craftsman_id, map_id, number, is_marked, was_added_with_client, description, response_limit, uploaded_at, registered_at, responded_at, reviewed_at, created_at, last_changed_at FROM issue');
    ...
    public function down(Schema $schema): void
    {
        ...
        , name CLOB NOT NULL, folder_name CLOB NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL, country CLOB DEFAULT NULL, image_filename CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO construction_site (id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__construction_site');
        $this->addSql('DROP TABLE __temp__construction_site');
        $this->addSql('DROP INDEX IDX_BC4D21F04994A532');
        $this->addSql('DROP INDEX IDX_BC4D21F0A69C9147');
        ...
        $this->addSql('DROP INDEX IDX_12AD233E34508F72');
        $this->addSql('DROP INDEX IDX_12AD233E53C55F64');
        $this->addSql('DROP INDEX IDX_12AD233EBCE08130');
        $this->addSql('CREATE TEMPORARY TABLE __temp__issue AS SELECT id, upload_by_id, registration_by_id, response_by_id, review_by_id, craftsman_id, map_id, number, is_marked, was_added_with_client, description, response_limit, uploaded_at, registered_at, responded_at, reviewed_at, created_at, last_changed_at FROM issue');
        $this->addSql('DROP TABLE issue');
        ...
        , image_filename CLOB DEFAULT NULL COLLATE BINARY, position_x DOUBLE PRECISION DEFAULT NULL, position_y DOUBLE PRECISION DEFAULT NULL, position_zoom_scale DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO issue (id, upload_by_id, registration_by_id, response_by_id, review_by_id, craftsman_id, map_id, number, is_marked, was_added_with_client, description, response_limit, uploaded_at, registered_at, responded_at, reviewed_at, created_at, last_changed_at) SELECT id, upload_by_id, registration_by_id, response_by_id, review_by_id, craftsman_id, map_id, number, is_marked, was_added_with_client, description, response_limit, uploaded_at, registered_at, responded_at, reviewed_at, created_at, last_changed_at FROM __temp__issue');
        $this->addSql('DROP TABLE __temp__issue');
        $this->addSql('CREATE INDEX IDX_12AD233E83BA6D1B ON issue (upload_by_id)');
        $this->addSql('CREATE INDEX IDX_12AD233E254D80EC ON issue (registration_by_id)');
        ...
        , filename CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO map (id, construction_site_id, parent_id, name, created_at, last_changed_at) SELECT id, construction_site_id, parent_id, name, created_at, last_changed_at FROM __temp__map');
        $this->addSql('DROP TABLE __temp__map');
        $this->addSql('CREATE INDEX IDX_93ADAABB4994A532 ON map (construction_site_id)');
        $this->addSql('CREATE INDEX IDX_93ADAABB727ACA70 ON map (parent_id)');
