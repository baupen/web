 ...
 */
final class Version20190317100207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // set the isTrialConstructionSite flag for the trial construction sites
        $this->addSql('UPDATE construction_site SET is_trial_construction_site = 1 WHERE id IN (
SELECT cs.id FROM construction_manager cm 
INNER JOIN construction_site_construction_manager cscm ON cscm.construction_manager_id = cm.id 
INNER JOIN construction_site cs ON cscm.construction_site_id = cs.id
WHERE is_trial_account = 1 
)');
    }
