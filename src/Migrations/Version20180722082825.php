 ...
 */
final class Version20180722082825 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, registration_start, registration_end, read_status, share_access_limit, trades, craftsmen, maps, number_text) SELECT id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, registration_start, registration_end, read_status, share_access_limit, trades, craftsmen, maps, number_text FROM __temp__filter');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__craftsman');
        $this->addSql('CREATE INDEX IDX_7DC593834994A532 ON craftsman (construction_site_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, construction_site, is_marked, number, trades, craftsmen, maps, registration_status, registration_start, registration_end, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, share_access_limit, number_text FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id CHAR(36) NOT NULL --(DC2Type:guid)
        , construction_site VARCHAR(255) DEFAULT NULL, is_marked BOOLEAN DEFAULT NULL, number INTEGER DEFAULT NULL, registration_status BOOLEAN DEFAULT NULL, registration_start DATETIME DEFAULT NULL, registration_end DATETIME DEFAULT NULL, read_status BOOLEAN DEFAULT NULL, responded_status BOOLEAN DEFAULT NULL, responded_start DATETIME DEFAULT NULL, responded_end DATETIME DEFAULT NULL, reviewed_status BOOLEAN DEFAULT NULL, reviewed_start DATETIME DEFAULT NULL, reviewed_end DATETIME DEFAULT NULL, limit_start DATETIME DEFAULT NULL, limit_end DATETIME DEFAULT NULL, share_access_limit DATETIME DEFAULT NULL, number_text CLOB DEFAULT NULL, trades CLOB DEFAULT \'NULL --(DC2Type:simple_array)\' COLLATE BINARY --(DC2Type:simple_array)
        ...
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, construction_site, is_marked, number, trades, craftsmen, maps, registration_status, registration_start, registration_end, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, share_access_limit, number_text) SELECT id, construction_site, is_marked, number, trades, craftsmen, maps, registration_status, registration_start, registration_end, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, share_access_limit, number_text FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
        $this->addSql('DROP INDEX IDX_12AD233E254D80EC');
        $this->addSql('DROP INDEX IDX_12AD233EBA91FB54');
