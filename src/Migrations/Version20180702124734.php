 ...
 */
final class Version20180702124734 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM filter');
        ...
        , construction_site VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end) SELECT id, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM __temp__filter');
    ...
    public function down(Schema $schema): void
    {
        ...
        , is_marked BOOLEAN DEFAULT NULL, number INTEGER DEFAULT NULL, read_status BOOLEAN DEFAULT NULL, responded_status BOOLEAN DEFAULT NULL, responded_start DATETIME DEFAULT NULL, responded_end DATETIME DEFAULT NULL, reviewed_status BOOLEAN DEFAULT NULL, reviewed_start DATETIME DEFAULT NULL, reviewed_end DATETIME DEFAULT NULL, limit_start DATETIME DEFAULT NULL, limit_end DATETIME DEFAULT NULL, trades CLOB DEFAULT NULL COLLATE BINARY, craftsmen CLOB DEFAULT NULL COLLATE BINARY, maps CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end) SELECT id, is_marked, number, trades, craftsmen, maps, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('DROP INDEX UNIQ_12AD233E96901F54');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
