 ...
 */
final class Version20180722113658 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , access_identifier CLOB DEFAULT NULL, last_access DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, registration_start, registration_end, read_status, access_until, number_text, trades, craftsmen, maps, issues) SELECT id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, registration_start, registration_end, read_status, share_access_limit, number_text, trades, craftsmen, maps, issues FROM __temp__filter');
    ...
    public function down(Schema $schema): void
    {
        ...
        , share_access_limit DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, construction_site, is_marked, number, trades, craftsmen, maps, issues, registration_status, registration_start, registration_end, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, number_text) SELECT id, construction_site, is_marked, number, trades, craftsmen, maps, issues, registration_status, registration_start, registration_end, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, number_text FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
        $this->addSql('DROP INDEX IDX_12AD233E254D80EC');
        $this->addSql('DROP INDEX IDX_12AD233EBA91FB54');
