 ...
 */
final class Version20180626124438 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , receiver CLOB NOT NULL COLLATE BINARY, subject CLOB NOT NULL COLLATE BINARY, body CLOB NOT NULL COLLATE BINARY, action_text CLOB DEFAULT NULL COLLATE BINARY, action_link CLOB DEFAULT NULL COLLATE BINARY, email_type INTEGER NOT NULL, sent_date_time DATETIME NOT NULL, visited_date_time DATETIME DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__craftsman');
        $this->addSql('CREATE INDEX IDX_7DC593834994A532 ON craftsman (construction_site_id)');
        $this->addSql('ALTER TABLE email ADD COLUMN identifier CLOB NOT NULL COLLATE BINARY');
        $this->addSql('ALTER TABLE email ADD COLUMN carbon_copy CLOB DEFAULT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
        $this->addSql('DROP INDEX IDX_12AD233E254D80EC');
        $this->addSql('DROP INDEX IDX_12AD233EBA91FB54');
        $this->addSql('DROP INDEX IDX_12AD233EB9690C1F');
