 ...
 */
final class Version20181218053109 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function up(Schema $schema): void
    {
        ...
        , name CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, is_automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_93ADAABB4994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_93ADAABB727ACA70 FOREIGN KEY (parent_id) REFERENCES map (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_93ADAABB93CB796C FOREIGN KEY (file_id) REFERENCES map_file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , identifier CLOB NOT NULL COLLATE BINARY, is_automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_F2702D4BCE08130 FOREIGN KEY (map_file_id) REFERENCES map_file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
