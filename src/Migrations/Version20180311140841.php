...
class Version20180311140841 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        , file_name CLOB NOT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B8D991E4D2A7E12 ON building_map (building_id)');
        $this->addSql('CREATE TABLE frontend_user (id CHAR(36) NOT NULL --(DC2Type:guid)
        , email CLOB NOT NULL, password_hash CLOB NOT NULL, reset_hash CLOB NOT NULL, is_enabled BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id))');
        ...
        , "key" CLOB NOT NULL, content CLOB NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9F74B8987887A021 ON setting (frontend_user_id)');
        $this->addSql('CREATE TABLE app_user (id CHAR(36) NOT NULL --(DC2Type:guid)
        , identifier CLOB NOT NULL, password_hash CLOB NOT NULL, authentication_token CLOB NOT NULL, given_name CLOB NOT NULL, family_name CLOB NOT NULL, PRIMARY KEY(id))');
        ...
        , name CLOB NOT NULL, description CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, email CLOB NOT NULL, webpage CLOB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE backend_user (id CHAR(36) NOT NULL --(DC2Type:guid)
        , email CLOB NOT NULL, password_hash CLOB NOT NULL, reset_hash CLOB NOT NULL, is_enabled BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id))');
