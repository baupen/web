 ...
 */
final class Version20180626124529 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , receiver CLOB NOT NULL COLLATE BINARY, subject CLOB NOT NULL COLLATE BINARY, body CLOB NOT NULL COLLATE BINARY, action_text CLOB DEFAULT NULL COLLATE BINARY, action_link CLOB DEFAULT NULL COLLATE BINARY, email_type INTEGER NOT NULL, visited_date_time DATETIME DEFAULT NULL, sent_date_time DATETIME DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        , receiver CLOB NOT NULL, subject CLOB NOT NULL, body CLOB NOT NULL, action_text CLOB DEFAULT NULL, action_link CLOB DEFAULT NULL, email_type INTEGER NOT NULL, visited_date_time DATETIME DEFAULT NULL, sent_date_time DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO email (id, receiver, subject, body, action_text, action_link, email_type, sent_date_time, visited_date_time) SELECT id, receiver, subject, body, action_text, action_link, email_type, sent_date_time, visited_date_time FROM __temp__email');
        $this->addSql('DROP TABLE __temp__email');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
        $this->addSql('DROP INDEX IDX_12AD233E254D80EC');
