 ...
 */
final class Version20180720123707 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , number_text CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, trades, craftsmen, maps, registration_start, registration_end, read_status, share_access_limit) SELECT id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, trades, craftsmen, maps, registration_start, registration_end, read_status, share_access_limit FROM __temp__filter');
