 ...
 */
final class Version20190419093333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , construction_site_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , contact_name CLOB NOT NULL COLLATE BINARY, company CLOB NOT NULL COLLATE BINARY, trade CLOB NOT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, last_email_sent DATETIME DEFAULT NULL, last_online_visit DATETIME DEFAULT NULL, email_identifier CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, write_authorization_token CLOB NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_7DC593834994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO craftsman (id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country, write_authorization_token) SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, email_identifier, created_at, last_changed_at, street_address, postal_code, locality, country, random() FROM __temp__craftsman');
        ...
        , public_access_identifier CLOB DEFAULT NULL, filter_by_issues BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_craftsmen BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_trades BOOLEAN DEFAULT \'0\' NOT NULL, filter_by_maps BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_7FC45F1D4994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO filter (id, is_marked, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, access_allowed_until, last_access, trades, craftsmen, maps, issues, any_status) SELECT id, is_marked, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, access_until, last_access, trades, craftsmen, maps, issues, any_status FROM __temp__filter');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, public_access_identifier, access_allowed_until, last_access, is_marked, issues, any_status, craftsmen, trades, maps, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id CHAR(36) NOT NULL --(DC2Type:guid)
        , last_access DATETIME DEFAULT NULL, is_marked BOOLEAN DEFAULT NULL, any_status INTEGER DEFAULT NULL, registration_status BOOLEAN DEFAULT NULL, registration_start DATETIME DEFAULT NULL, registration_end DATETIME DEFAULT NULL, responded_status BOOLEAN DEFAULT NULL, responded_start DATETIME DEFAULT NULL, responded_end DATETIME DEFAULT NULL, reviewed_status BOOLEAN DEFAULT NULL, reviewed_start DATETIME DEFAULT NULL, reviewed_end DATETIME DEFAULT NULL, limit_start DATETIME DEFAULT NULL, limit_end DATETIME DEFAULT NULL, number_text CLOB DEFAULT NULL COLLATE BINARY, access_until DATETIME DEFAULT NULL, issues CLOB DEFAULT \'NULL --(DC2Type:simple_array)\' COLLATE BINARY --(DC2Type:simple_array)
        ...
        , construction_site VARCHAR(255) DEFAULT NULL COLLATE BINARY, number INTEGER DEFAULT NULL, read_status BOOLEAN DEFAULT NULL, access_identifier CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, number_text, access_until, last_access, is_marked, issues, any_status, craftsmen, trades, maps, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end) SELECT id, public_access_identifier, access_allowed_until, last_access, is_marked, issues, any_status, craftsmen, trades, maps, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end FROM __temp__filter');
        $this->addSql('DROP TABLE __temp__filter');
        $this->addSql('DROP INDEX IDX_12AD233E83BA6D1B');
        $this->addSql('DROP INDEX IDX_12AD233E254D80EC');
        $this->addSql('DROP INDEX IDX_12AD233EBA91FB54');
