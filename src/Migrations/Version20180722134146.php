 ...
 */
final class Version20180722134146 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, registration_start, registration_end, read_status, number_text, access_until, trades, craftsmen, maps, issues, access_identifier, last_access) SELECT id, is_marked, number, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, registration_status, registration_start, registration_end, read_status, number_text, access_until, trades, craftsmen, maps, issues, access_identifier, last_access FROM __temp__filter');
