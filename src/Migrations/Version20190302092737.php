 ...
 */
final class Version20190302092737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_site AS SELECT id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country, is_automatic_edit_enabled FROM construction_site');
        ...
        , name CLOB NOT NULL COLLATE BINARY, folder_name CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, is_automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_BF4E61B43DA5256D FOREIGN KEY (image_id) REFERENCES construction_site_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO construction_site (id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country, is_automatic_edit_enabled) SELECT id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country, is_automatic_edit_enabled FROM __temp__construction_site');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_manager AS SELECT id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, is_trial_account FROM construction_manager');
        ...
        , given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, locale CLOB DEFAULT \'de\' NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, email CLOB NOT NULL COLLATE BINARY, password CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, is_enabled BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, is_trial_account BOOLEAN DEFAULT \'0\' NOT NULL, authentication_hash CLOB NOT NULL, is_registration_completed BOOLEAN NOT NULL, authentication_source CLOB NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_450D96CDA7F12217 FOREIGN KEY (active_construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO construction_manager (id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, authentication_hash, is_enabled, registration_date, is_trial_account, is_registration_completed, authentication_source) SELECT id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, is_trial_account, true, "none" FROM __temp__construction_manager');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_450D96CDE7927C74');
        $this->addSql('DROP INDEX IDX_450D96CDA7F12217');
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_manager AS SELECT id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, created_at, last_changed_at, email, password, password_hash, is_enabled, registration_date FROM construction_manager');
        $this->addSql('DROP TABLE construction_manager');
        $this->addSql('CREATE TABLE construction_manager (id CHAR(36) NOT NULL --(DC2Type:guid)
        , given_name CLOB DEFAULT NULL, family_name CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, locale CLOB DEFAULT \'de\' NOT NULL, is_trial_account BOOLEAN DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, email CLOB NOT NULL, password CLOB NOT NULL, password_hash CLOB NOT NULL, is_enabled BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, active_construction_site_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        , reset_hash CLOB NOT NULL COLLATE BINARY, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO construction_manager (id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, created_at, last_changed_at, email, password, password_hash, is_enabled, registration_date) SELECT id, active_construction_site_id, given_name, family_name, phone, locale, is_trial_account, created_at, last_changed_at, email, password, password_hash, is_enabled, registration_date FROM __temp__construction_manager');
        $this->addSql('DROP TABLE __temp__construction_manager');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_450D96CDE7927C74 ON construction_manager (email)');
        $this->addSql('CREATE INDEX IDX_450D96CDA7F12217 ON construction_manager (active_construction_site_id)');
        $this->addSql('DROP INDEX IDX_BF4E61B43DA5256D');
