 ...
 */
final class Version20180703112031 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id, is_marked, number, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, trades, craftsmen, maps FROM filter');
        ...
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id, is_marked, number, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, trades, craftsmen, maps) SELECT id, is_marked, number, read_status, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, construction_site, trades, craftsmen, maps FROM __temp__filter');
