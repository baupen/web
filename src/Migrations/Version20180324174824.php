 ...
 */
class Version20180324174824 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__building_map AS SELECT id, building_id, name, description, file_name FROM building_map');
        ...
        , name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, file_name CLOB DEFAULT NULL COLLATE BINARY, public_identifier CLOB DEFAULT NULL, public_identifier_valid_till DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_B8D991E4D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO building_map (id, building_id, name, description, file_name) SELECT id, building_id, name, description, file_name FROM __temp__building_map');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__marker AS SELECT id, craftsman_id, building_map_id, created_by_id, approved, mark_xpercentage, mark_ypercentage, frame_xpercentage, frame_ypercentage, frame_xheight, frame_ylength, content, image_file_name, created_at, last_changed_at FROM marker');
        ...
        $this->addSql('ALTER TABLE building ADD COLUMN public_identifier CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE building ADD COLUMN public_identifier_valid_till DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX IDX_454BA9BD4A3353D8 ON app_user_buildings (app_user_id)');
        $this->addSql('CREATE INDEX IDX_454BA9BD4D2A7E12 ON app_user_buildings (building_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__building AS SELECT id, is_archived, name, description, street, street_nr, address_line, postal_code, city, country FROM building');
        $this->addSql('DROP TABLE building');
        $this->addSql('CREATE TABLE building (id CHAR(36) NOT NULL --(DC2Type:guid)
        , is_archived BOOLEAN DEFAULT \'0\' NOT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO building (id, is_archived, name, description, street, street_nr, address_line, postal_code, city, country) SELECT id, is_archived, name, description, street, street_nr, address_line, postal_code, city, country FROM __temp__building');
        ...
        , file_name CLOB DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, building_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        , PRIMARY KEY(id))');
