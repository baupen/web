 ...
 */
final class Version20181125160722 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        , name CLOB NOT NULL, filename CLOB DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, PRIMARY KEY(id))');
        ...
        , name CLOB NOT NULL, folder_name CLOB NOT NULL, image_filename CLOB DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL, country CLOB DEFAULT NULL, PRIMARY KEY(id))');
