 ...
 */
final class Version20180629150515 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__craftsman AS SELECT id, construction_site_id, contact_name, company, trade, email, created_at, last_changed_at, street_address, postal_code, locality, country, last_email_sent, last_online_visit FROM craftsman');
        ...
        $this->addSql('ALTER TABLE filter ADD COLUMN is_marked BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN number INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN trades CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN craftsmen CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN maps CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN read_status BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN responded_status BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN responded_start DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN responded_end DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN reviewed_status BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN reviewed_start DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN reviewed_end DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN limit_start DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE filter ADD COLUMN limit_end DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_BC4D21F0A69C9147 ON construction_site_construction_manager (construction_manager_id)');
        $this->addSql('DROP INDEX IDX_7DC593834994A532');
        $this->addSql('CREATE TEMPORARY TABLE __temp__craftsman AS SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, created_at, last_changed_at, street_address, postal_code, locality, country FROM craftsman');
        $this->addSql('DROP TABLE craftsman');
        ...
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO craftsman (id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, construction_site_id, contact_name, company, trade, email, last_email_sent, last_online_visit, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__craftsman');
        $this->addSql('DROP TABLE __temp__craftsman');
        $this->addSql('CREATE INDEX IDX_7DC593834994A532 ON craftsman (construction_site_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__filter AS SELECT id FROM filter');
        $this->addSql('DROP TABLE filter');
        $this->addSql('CREATE TABLE filter (id CHAR(36) NOT NULL --(DC2Type:guid)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO filter (id) SELECT id FROM __temp__filter');
