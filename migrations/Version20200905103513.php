 ...
 */
final class Version20200905103513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE construction_site (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', image_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', name LONGTEXT NOT NULL, folder_name LONGTEXT NOT NULL, is_trial_construction_site TINYINT(1) DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address LONGTEXT DEFAULT NULL, postal_code INT DEFAULT NULL, locality LONGTEXT DEFAULT NULL, country LONGTEXT DEFAULT NULL, is_automatic_edit_enabled LONGTEXT NOT NULL, INDEX IDX_BF4E61B43DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE map (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', construction_site_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', parent_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', file_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', name LONGTEXT NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, is_automatic_edit_enabled LONGTEXT NOT NULL, INDEX IDX_93ADAABB4994A532 (construction_site_id), INDEX IDX_93ADAABB727ACA70 (parent_id), INDEX IDX_93ADAABB93CB796C (file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
