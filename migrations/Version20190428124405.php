 ...
 */
final class Version20190428124405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO filter (id, construction_site_id, is_marked, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, last_access, any_status, access_allowed_until, trades, craftsmen, maps, issues, public_access_identifier, filter_by_issues, filter_by_craftsmen, filter_by_trades, filter_by_maps) SELECT id, construction_site_id, is_marked, registration_status, registration_start, registration_end, responded_status, responded_start, responded_end, reviewed_status, reviewed_start, reviewed_end, limit_start, limit_end, last_access, any_status, access_allowed_until, trades, craftsmen, maps, issues, public_access_identifier, filter_by_issues, filter_by_craftsmen, filter_by_trades, filter_by_maps FROM __temp__filter');
    ...
    public function down(Schema $schema): void
    {
        ...
        , authentication_source CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
