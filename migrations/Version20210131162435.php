 ...
 */
final class Version20210131162435 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE construction_manager (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', given_name LONGTEXT DEFAULT NULL, family_name LONGTEXT DEFAULT NULL, phone LONGTEXT DEFAULT NULL, locale LONGTEXT NOT NULL, is_admin_account TINYINT(1) DEFAULT \'0\' NOT NULL, is_trial_account TINYINT(1) DEFAULT \'0\' NOT NULL, is_external_account TINYINT(1) DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, authentication_token LONGTEXT NOT NULL, email VARCHAR(255) NOT NULL, password LONGTEXT DEFAULT NULL, authentication_hash LONGTEXT DEFAULT NULL, is_enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_450D96CDE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
