 ...
 */
final class Version20181216092743 extends AbstractMigration
{
    /**
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__map_sector AS SELECT id, map_file_id, name, color, points, identifier FROM map_sector');
        ...
        , identifier CLOB NOT NULL COLLATE BINARY, automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_F2702D4BCE08130 FOREIGN KEY (map_file_id) REFERENCES map_file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO map_sector (id, map_file_id, name, color, points, identifier) SELECT id, map_file_id, name, color, points, identifier FROM __temp__map_sector');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_site AS SELECT id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM construction_site');
        ...
        , name CLOB NOT NULL COLLATE BINARY, folder_name CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_BF4E61B43DA5256D FOREIGN KEY (image_id) REFERENCES construction_site_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO construction_site (id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__construction_site');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__construction_manager AS SELECT id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, agb_accepted FROM construction_manager');
        ...
        $this->addSql('INSERT INTO construction_manager (id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, agb_accepted) SELECT id, active_construction_site_id, given_name, family_name, phone, locale, created_at, last_changed_at, email, password, password_hash, reset_hash, is_enabled, registration_date, agb_accepted FROM __temp__construction_manager');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__map AS SELECT id, construction_site_id, parent_id, file_id, name, created_at, last_changed_at FROM map');
        ...
        , name CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, automatic_edit_enabled CLOB DEFAULT \'1\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_93ADAABB4994A532 FOREIGN KEY (construction_site_id) REFERENCES construction_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_93ADAABB727ACA70 FOREIGN KEY (parent_id) REFERENCES map (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_93ADAABB93CB796C FOREIGN KEY (file_id) REFERENCES map_file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO map (id, construction_site_id, parent_id, file_id, name, created_at, last_changed_at) SELECT id, construction_site_id, parent_id, file_id, name, created_at, last_changed_at FROM __temp__map');
        ...
        , issue_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , map_file_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , position_x DOUBLE PRECISION DEFAULT NULL, position_y DOUBLE PRECISION DEFAULT NULL, position_zoom_scale DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_9184CE5E5E7AA58C FOREIGN KEY (issue_id) REFERENCES issue (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9184CE5EBCE08130 FOREIGN KEY (map_file_id) REFERENCES map_file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , name CLOB NOT NULL, folder_name CLOB NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, locality CLOB DEFAULT NULL, country CLOB DEFAULT NULL, image_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        , prevent_automatic_edit CLOB DEFAULT \'\' NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO construction_site (id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country) SELECT id, image_id, name, folder_name, created_at, last_changed_at, street_address, postal_code, locality, country FROM __temp__construction_site');
        $this->addSql('DROP TABLE __temp__construction_site');
        $this->addSql('CREATE INDEX IDX_BF4E61B43DA5256D ON construction_site (image_id)');
        $this->addSql('DROP INDEX IDX_BC4D21F04994A532');
        ...
        , position_x DOUBLE PRECISION DEFAULT NULL, position_y DOUBLE PRECISION DEFAULT NULL, position_zoom_scale DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, issue_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        ...
        , name CLOB NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, construction_site_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        ...
        , identifier CLOB NOT NULL, map_file_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        , prevent_automatic_edit CLOB DEFAULT \'\' NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO map_sector (id, map_file_id, name, color, points, identifier) SELECT id, map_file_id, name, color, points, identifier FROM __temp__map_sector');
        $this->addSql('DROP TABLE __temp__map_sector');
        $this->addSql('CREATE INDEX IDX_F2702D4BCE08130 ON map_sector (map_file_id)');
