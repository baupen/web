 ...
 */
final class Version20210211142205 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE construction_manager (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', given_name LONGTEXT DEFAULT NULL, family_name LONGTEXT DEFAULT NULL, phone LONGTEXT DEFAULT NULL, locale LONGTEXT NOT NULL, authorization_authority LONGTEXT DEFAULT NULL, is_admin_account TINYINT(1) DEFAULT \'0\' NOT NULL, can_associate_self TINYINT(1) DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, authentication_token LONGTEXT NOT NULL, email VARCHAR(255) NOT NULL, password LONGTEXT DEFAULT NULL, authentication_hash LONGTEXT DEFAULT NULL, is_enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_450D96CDE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE construction_site (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', image_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', name LONGTEXT NOT NULL, folder_name LONGTEXT NOT NULL, is_trial_construction_site TINYINT(1) DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, street_address LONGTEXT NOT NULL, postal_code INT NOT NULL, locality LONGTEXT NOT NULL, country LONGTEXT NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_BF4E61B43DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE construction_site_image (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_for_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, filename LONGTEXT NOT NULL, hash LONGTEXT NOT NULL, INDEX IDX_DFC5717E2F97E6E2 (created_for_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE email_template (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', construction_site_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', name LONGTEXT NOT NULL, subject LONGTEXT NOT NULL, body LONGTEXT NOT NULL, purpose INT DEFAULT NULL, self_bcc TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, INDEX IDX_9C0600CA4994A532 (construction_site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE issue (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', image_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', craftsman_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', map_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', construction_site_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', registered_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', resolved_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', closed_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', number INT NOT NULL, is_marked TINYINT(1) NOT NULL, was_added_with_client TINYINT(1) NOT NULL, description LONGTEXT DEFAULT NULL, deadline DATETIME DEFAULT NULL, last_changed_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, position_x DOUBLE PRECISION DEFAULT NULL, position_y DOUBLE PRECISION DEFAULT NULL, position_zoom_scale DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, registered_at DATETIME DEFAULT NULL, resolved_at DATETIME DEFAULT NULL, closed_at DATETIME DEFAULT NULL, INDEX IDX_12AD233E3DA5256D (image_id), INDEX IDX_12AD233E34508F72 (craftsman_id), INDEX IDX_12AD233E53C55F64 (map_id), INDEX IDX_12AD233E4994A532 (construction_site_id), INDEX IDX_12AD233EB03A8386 (created_by_id), INDEX IDX_12AD233E27E92E18 (registered_by_id), INDEX IDX_12AD233E6713A32B (resolved_by_id), INDEX IDX_12AD233EE1FA7797 (closed_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE issue_image (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_for_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, filename LONGTEXT NOT NULL, hash LONGTEXT NOT NULL, INDEX IDX_57B76D0C2F97E6E2 (created_for_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE map_file (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_for_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, filename LONGTEXT NOT NULL, hash LONGTEXT NOT NULL, INDEX IDX_1FB791852F97E6E2 (created_for_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE construction_site_image ADD CONSTRAINT FK_DFC5717E2F97E6E2 FOREIGN KEY (created_for_id) REFERENCES construction_site (id)');
        ...
        $this->addSql('ALTER TABLE issue_image ADD CONSTRAINT FK_57B76D0C2F97E6E2 FOREIGN KEY (created_for_id) REFERENCES issue (id)');
        ...
        $this->addSql('ALTER TABLE map_file ADD CONSTRAINT FK_1FB791852F97E6E2 FOREIGN KEY (created_for_id) REFERENCES map (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE construction_site_image DROP FOREIGN KEY FK_DFC5717E2F97E6E2');
        ...
        $this->addSql('ALTER TABLE issue_image DROP FOREIGN KEY FK_57B76D0C2F97E6E2');
        ...
        $this->addSql('ALTER TABLE map_file DROP FOREIGN KEY FK_1FB791852F97E6E2');
