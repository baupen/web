 ...
 */
final class Version20240809080332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE protocol_entry ADD file_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE protocol_entry DROP file_id');
    }
}
