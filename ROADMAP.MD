...
- Issue Filter: Preview number of results per filter criteria. Order by multiple criteria. Filter by construction manager. When collapsing entries, show summary of active filter.
