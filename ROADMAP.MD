...
- Issue Filter: Preview number of results per filter criteria. When collapsing entries, show summary of active filter. Order by map (considering parent structure).
