<template>
  <button-with-modal-confirm
      :button-disabled="posting" :title="$t('_action.associate_construction_manager')" :can-confirm="canConfirm"
      @confirm="confirm">
    ...
    confirm: function () {
      ...
      api.postConstructionManager(this.post)
          .then(constructionManager => {
            ...
            api.patch(this.constructionSite, { constructionManagers }, this.$t('_action.messages.success.construction_manager_associated'))
                .then(_ => {
                  this.posting = false
