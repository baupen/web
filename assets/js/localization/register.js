export default {
    ...
    it: {
        ...
        filter: {
            name: "Filtro",
            later_than: "dopo di",
            earlier_than: "prima di",
            status_set: "Stato fissato",
            time: "Ora",
            time_set: "{state} alle"
        },
        export: {
            ...
            pdf: {
                ...
                generate: "generare",
                tables: {
                    name: "Tabelle riassuntive",
                    table_by_craftsman: "per impresa",
                    table_by_trade: "per operaio",
                    table_by_map: "per carte"
                }
            },
            link: {
                name: "Link",
                with_limit: "Con data di scadenza",
                valid_till: "valevole fino",
                generate: "creare"
            }
        }
    }
